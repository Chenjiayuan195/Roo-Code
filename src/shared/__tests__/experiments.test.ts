	...
	describe("POWER_STEERING", () => {
		it("is configured correctly", () => {
			...
			expect(experimentConfigsMap.POWER_STEERING).toMatchObject({
				...
				description:
					"When enabled, Magic will remind the model about the details of its current mode definition more frequently. This will lead to stronger adherence to role definitions and custom instructions, but will use more tokens per message.",
				enabled: false,
			})
		})
	})
