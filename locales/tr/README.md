...
<br>
<div align="center">
  <h2>Magic Code Topluluğuna Katılın</h2>
...
<div align="center">
<h1>Magic Code (önceki adıyla Magic Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code" target="_blank"><img src="https://img.shields.io/badge/VS%20Marketplace%27den%20İndir-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="VS Marketplace'den İndir"></a>
<a href="https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Özellik%20İstekleri-yellow?style=for-the-badge" alt="Özellik İstekleri"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Değerlendir%20%26%20İnceleme-green?style=for-the-badge" alt="Değerlendir & İnceleme"></a>
...
**Magic Code**, editörünüzde çalışan yapay zeka destekli **otonom kodlama aracı**dır. Yapabilecekleri:
...
İster esnek bir kodlama ortağı, ister bir sistem mimarı, isterse QA mühendisi veya ürün yöneticisi gibi uzmanlaşmış roller arıyor olun, Magic Code yazılım geliştirme sürecinizi daha verimli hale getirmenize yardımcı olabilir.

Detaylı güncellemeler ve düzeltmeler için [CHANGELOG](../CHANGELOG.md) dosyasını kontrol edin.

---

## 🎉 Magic Code 3.9 Yayınlandı

Magic Code 3.9 uluslararası oldu!

- Magic Code 14 farklı dile çevrildi! Tüm dilleri görmek ve ayarlarınızı değiştirmek için Ayarlar → Dil bölümüne gidin.
...
1. [Magic Code'u Yükleyin](https://docs.roocode.com/getting-started/installing)
...
Magic Code, özelleştirilmiş [modlar](https://docs.roocode.com/basic-usage/modes) ile ihtiyaçlarınıza uyum sağlar:
...
Magic Code, şunları yapabilen güçlü [araçlar](https://docs.roocode.com/basic-usage/using-tools) ile gelir:
...
MCP, sınırsız özel araç eklemenize izin vererek Magic Code'un yeteneklerini genişletir. Harici API'lerle entegre olun, veritabanlarına bağlanın veya özel geliştirme araçları oluşturun - MCP, Magic Code'un işlevselliğini özel ihtiyaçlarınızı karşılamak üzere genişletmek için çerçeve sağlar.

### Özelleştirme

Magic Code'u kendi tarzınıza göre çalıştırın:
...
- **GitHub:** [Sorunları bildirin](https://github.com/RooVetGit/Magic-Code/issues) veya [özellik talep edin](https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
Magic Code'u daha iyi hale getirmeye yardımcı olan tüm katkıda bulunanlara teşekkür ederiz!
