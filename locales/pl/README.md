...
<br>
<div align="center">
  <h2>Dołącz do społeczności Magic Code</h2>
...
<div align="center">
<h1>Magic Code (wcześniej Magic Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code" target="_blank"><img src="https://img.shields.io/badge/Pobierz%20z%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Pobierz z VS Marketplace"></a>
<a href="https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Prośby%20o%20funkcje-yellow?style=for-the-badge" alt="Prośby o funkcje"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Oceń%20%26%20Zrecenzuj-green?style=for-the-badge" alt="Oceń & Zrecenzuj"></a>
...
**Magic Code** to napędzany przez AI **autonomiczny agent kodujący**, który funkcjonuje w Twoim edytorze. Potrafi:
...
Niezależnie od tego, czy szukasz elastycznego partnera do kodowania, architekta systemu, czy wyspecjalizowanych ról, takich jak inżynier QA lub menedżer produktu, Magic Code może pomóc Ci budować oprogramowanie efektywniej.

Sprawdź [CHANGELOG](../CHANGELOG.md), aby uzyskać szczegółowe informacje o aktualizacjach i poprawkach.

---

## 🎉 Magic Code 3.9 został wydany

Magic Code 3.9 staje się międzynarodowy!

- Magic Code został przetłumaczony na 14 różnych języków! Przejdź do Ustawienia → Język, aby zobaczyć wszystkie języki i zmienić swoje ustawienia.
...
1. [Zainstaluj Magic Code](https://docs.roocode.com/getting-started/installing)
...
Magic Code dostosowuje się do Twoich potrzeb za pomocą wyspecjalizowanych [trybów](https://docs.roocode.com/basic-usage/modes):
...
Magic Code jest wyposażony w potężne [narzędzia](https://docs.roocode.com/basic-usage/using-tools), które mogą:
...
MCP rozszerza możliwości Magic Code, umożliwiając dodawanie nieograniczonej liczby niestandardowych narzędzi. Integruj się z zewnętrznymi API, łącz z bazami danych lub twórz wyspecjalizowane narzędzia deweloperskie - MCP zapewnia framework, aby rozszerzyć funkcjonalność Magic Code w celu spełnienia Twoich specyficznych potrzeb.

### Personalizacja

Spraw, aby Magic Code działał po Twojemu za pomocą:
...
- **GitHub:** [Zgłaszaj problemy](https://github.com/RooVetGit/Magic-Code/issues) lub [proś o funkcje](https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
Dziękujemy wszystkim naszym współtwórcom, którzy pomogli ulepszyć Magic Code!
