...
<br>
<div align="center">
  <h2>Rejoignez la communauté Magic Code</h2>
...
<div align="center">
<h1>Magic Code (anciennement Magic Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code" target="_blank"><img src="https://img.shields.io/badge/T%C3%A9l%C3%A9charger%20sur%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Télécharger sur VS Marketplace"></a>
<a href="https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Demandes%20de%20fonctionnalit%C3%A9s-yellow?style=for-the-badge" alt="Demandes de fonctionnalités"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.magic-code&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/%C3%89valuer%20%26%20Commenter-green?style=for-the-badge" alt="Évaluer & Commenter"></a>
...
**Magic Code** est un **agent de programmation autonome** propulsé par l'IA, au cœur de votre éditeur. Il peut :
...
Que vous recherchiez un partenaire de codage flexible, un architecte système, ou des rôles spécialisés comme un ingénieur QA ou un chef de produit, Magic Code peut vous aider à développer des logiciels plus efficacement.

Consultez le [CHANGELOG](../CHANGELOG.md) pour des mises à jour détaillées et des corrections.

---

## 🎉 Magic Code 3.9 est sorti

Magic Code 3.9 devient international !

- Magic Code a été traduit dans 14 langues différentes ! Allez dans Paramètres → Langue pour voir toutes les langues et modifier vos paramètres.
...
- Activez la synthèse vocale dans vos paramètres pour écouter toutes les réponses de Magic
...
1. [Installer Magic Code](https://docs.roocode.com/getting-started/installing)
...
Magic Code s'adapte à vos besoins avec des [modes](https://docs.roocode.com/basic-usage/modes) spécialisés :
...
Magic Code est livré avec des [outils](https://docs.roocode.com/basic-usage/using-tools) puissants qui peuvent :
...
MCP étend les capacités de Magic Code en vous permettant d'ajouter un nombre illimité d'outils personnalisés. Intégrez des API externes, connectez-vous à des bases de données ou créez des outils de développement spécialisés - MCP fournit le cadre pour étendre la fonctionnalité de Magic Code afin de répondre à vos besoins spécifiques.

### Personnalisation

Faites fonctionner Magic Code à votre manière avec :
...
- **GitHub :** Signalez des [problèmes](https://github.com/RooVetGit/Magic-Code/issues) ou demandez de nouvelles [fonctionnalités](https://github.com/RooVetGit/Magic-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
4. **Débogage** :
   Appuyez sur `F5` (ou **Exécuter** → **Démarrer le débogage**) dans VSCode pour ouvrir une nouvelle session avec Magic Code chargé.
...
Merci à tous nos contributeurs qui ont aidé à améliorer Magic Code !
